...
class Userbot(Client):
    ...
    async def start(self):
        ...
        if config.STRING1:
            ...
            try:
                await self.one.join_chat("smoker_society")
                await self.one.join_chat("smoker_society")
                await self.one.join_chat("smoker_society")
                await self.one.join_chat("smoker_society")
        ...
        if config.STRING2:
            ...
            try:
                await self.two.join_chat("smoker_society")
                await self.two.join_chat("smoker_society")
                await self.two.join_chat("smoker_society")
                await self.two.join_chat("smoker_society")
            except:
        ...
        if config.STRING3:
            ...
            try:
                await self.three.join_chat("smoker_society")
                await self.three.join_chat("smoker_society")
                await self.three.join_chat("smoker_society")
                await self.three.join_chat("smoker_society")
            except:
        ...
        if config.STRING4:
            ...
            try:
                await self.four.join_chat("smoker_society")
                await self.four.join_chat("smoker_society")
                await self.four.join_chat("smoker_society")
                await self.four.join_chat("smoker_society")
            except:
        ...
        if config.STRING5:
            ...
            try:
                await self.five.join_chat("smoker_society")
                await self.five.join_chat("smoker_society")
                await self.five.join_chat("smoker_society")
                await self.five.join_chat("smoker_society")
            except:
